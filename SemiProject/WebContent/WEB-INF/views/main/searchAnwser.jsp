...
<img alt="상품이미지" src="./resources/img/best_temp.jpg" onerror="this.src='../resources/img/best_temp.jpg'" width="250" height="200">
<%-- <img alt="상품이미지" src="<%=pList.get(i).getProduct_img()%>" onerror="this.src='../resources/img/best_temp.jpg'"> --%>

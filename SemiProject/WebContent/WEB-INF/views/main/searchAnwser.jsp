...
<div style="width:250px;height:250px;box-shadow:3px 3px 3px #eee;box-sizing: border-box;float:left;margin-right:20px;margin-bottom:20px;cursor:pointer" onclick="location.href='/product/detail?product=<%=pList.get(i).getProduct_no() %>'">

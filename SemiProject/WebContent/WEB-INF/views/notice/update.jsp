...
<%
	ManagerNotice updateNotice = (ManagerNotice) request.getAttribute("updateNotice");
%>
...
<tr><td class="info">관리자번호</td><td><%=updateNotice.getManagerNo() %></td></tr>
<tr><td class="info">제목</td><td><input type="text" name="title" style="width:100%" value="<%=updateNotice.getTitle() %>"/></td></tr>
<tr><td class="info" colspan="2">본문</td></tr>
<tr><td colspan="2"><textarea id="content" name="content"><%=updateNotice.getContent() %></textarea></td></tr>
</table>
</form>

...
<section>
	...
	<div class="admin-content_area">
		<div class="admin-content">
			...
			<h3 class="item-add-title">제품 수정</h3>
			<hr>
			...
			<div>
				...
				<table class="table table-bordered">
					<tr>
						...
						<td><input type="text" name="product_name" style="width:100%" value="<%=product.getProduct_name()%>"></td>
					</tr>
					<tr>
					...
					<tr>
						<td colspan="2"><textarea id="content" name="content"><%=product.getProduct_content() %></textarea></td>
					</tr>
				</table>
				
					첨부파일 <input type="file" name="file" multiple value="<%=product.getProduct_img() %>">
			...
			<div class="text-center" style="margin: 5px;">
				<button type="button" id="btnWrite" class="btn btn-info add-btn">수정</button>
